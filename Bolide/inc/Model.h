...
private:
    ...
    Mesh processMesh(aiMesh* mesh, const aiScene* scene)
    {
        ...
        bool meshTransparent = 0;
        float opacity = 1.0f;
        //cout << (int) mesh->mNumVertices;
        ...
        meshTransparent = material->GetTextureCount(aiTextureType_OPACITY) > 0;
        ...
        // 5. opacity maps
        //std::vector<TextureMesh> opacityMaps = loadMaterialTextures(material, aiTextureType_OPACITY, "texture_opacity");
        //textures.insert(textures.end(), opacityMaps.begin(), opacityMaps.end());


        // return a mesh object created from the extracted mesh data
        return Mesh(vertices, indices, textures, meshTransparent);
    }
...
unsigned int TextureFromFile(const char* path, const string& directory, bool gamma)
{
    ...
    if (data)
    {
        ...
        //std::cout << "Texture path: " << path << " nrComponents" << nrComponents << std::endl;
